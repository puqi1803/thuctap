<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($stmt->execute()) {
            $id_collaborator = $conn->insert_id;
            ...
            <div class="row my-5 column-gap-4">
                <div class="col-9 d-flex flex-column row-gap-2">
                    ...
                    <div class="d-flex flex-row column-gap-2 align-items-center">
                        ...
                        <input type="text" id="doi-collaborator" name="doi-collaborator">
                    </div>
                    <div class="d-flex flex-row column-gap-2 align-items-center">
                    ...
                    <div class="d-flex flex-row column-gap-2 align-items-center">
                        ...
                        <input type="text" id="tax-collaborator" name="tax-collaborator">
                    </div>
                    <div class="d-flex flex-row column-gap-2 align-items-center">
                        <label class="w-25" for="number-bank-collaborator">Số tài khoản</label>
                        <input type="text" id="number-bank-collaborator" name="number-bank-collaborator">
                    </div>
                    <div class="d-flex flex-row column-gap-2 align-items-center">
                        <label class="w-25" for="bank-collaborator">Ngân hàng</label>
                        <input type="text" id="bank-collaborator" name="bank-collaborator">
                    </div>
                    <div class="d-flex flex-row column-gap-2 align-items-center">
                ...
                <div class="col d-flex flex-column row-gap-2">
                    ...
                    <div class="d-flex flex-row column-gap-4 justify-content-end mt-4"> 
